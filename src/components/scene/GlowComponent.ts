...
export class GlowComponent extends Component {
  ...
  strength = new NumberProp('Strength', { default: 1.2, min: 0,   max: 4,  step: 0.05, shortLabel: 'S'  })
  radius   = new NumberProp('Radius',   { default: 10,  min: 1,   max: 40, step: 0.5,  shortLabel: 'R'  })
}
